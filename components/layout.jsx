          ...
          <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
            ...
            {!user ? (
              <div className="flex space-x-4">
                <Link href="/login">
                  <a className="text-sm px-4 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-teal-500 hover:bg-white mt-4 lg:mt-0">
                    Sign in
                  </a>
                </Link>
                <Link href="/signup">
